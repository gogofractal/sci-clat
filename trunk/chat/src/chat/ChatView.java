...
public class ChatView extends FrameView {
    ...
    private void initComponents() {
        ...
        mainPanel.setMinimumSize(new java.awt.Dimension(600, 480));
        mainPanel.setName("mainPanel"); // NOI18N
        mainPanel.setPreferredSize(new java.awt.Dimension(600, 480));

        jScrollPane1.setName("jScrollPane1"); // NOI18N

        jtaInput.setColumns(20);
        jtaInput.setRows(5);
        jtaInput.setName("jtaInput"); // NOI18N
    ...
    @Action
    public void send() {
        System.out.println(this.jtaInput.getText());
    ...
    public int addLine(){
        char c = '\0';
        try {
            if((c = (char) System.in.read()) == 65535){
                return -1;
            }
        } catch (IOException ex) {
            Logger.getLogger(ChatView.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.jtaOutput.append("" + c);
        return 0;
    }
